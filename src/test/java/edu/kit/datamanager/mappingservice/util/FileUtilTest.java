...
public class FileUtilTest {
  ...
  void cloneValidGitRepository() {
    Path util = null;
    Path tempDir = Paths.get("/tmp", "mappingServiceTest" + UUID.randomUUID().toString());
    try {
      util = FileUtil.cloneGitRepository("https://github.com/kit-data-manager/mapping-service.git", "main", tempDir.toString());
    } catch (Exception e) {
      fail(e);
    }
    try {
