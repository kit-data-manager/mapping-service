...
// */
//package edu.kit.datamanager.mappingservice.indexer.messagehandler;
//
...
//import edu.kit.datamanager.mappingservice.indexer.consumer.IConsumerEngine;
//
...
//      String errorMessage = String.format("Error reading mapping file from '%s'", resultPath);
