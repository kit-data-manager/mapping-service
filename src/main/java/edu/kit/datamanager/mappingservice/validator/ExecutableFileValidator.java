 ...
 */
package edu.kit.datamanager.mappingservice.validator;

import edu.kit.datamanager.mappingservice.annotations.ExecutableFileURL;
...
public class ExecutableFileValidator implements ConstraintValidator<ExecutableFileURL, java.net.URL> {
  ...
  public boolean isValid(java.net.URL value, ConstraintValidatorContext context) {
    ...
    try {
      LOGGER.trace("Successfully validated file URL {}. Checking local path.", value.toURI());
